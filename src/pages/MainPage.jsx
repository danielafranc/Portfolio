...
const MainPage = () => {
    return (
      ...
      <div id='inicio'>
            ...
            <h2 className='text-[55px] mb-6 text-left leading-none text-white font-bold font-[poppins]'>turning ideas into real life <span id='css-selector'>products</span> is my calling.</h2>
