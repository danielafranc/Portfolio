...
function Conocimiento() {
    ...
    return (
        ...
        <div className='flex  flex-col items-center lg:flex-row my-8 p-8 gap-3'>
        {data.map((item) => (
            <div className='bg-white p-8 m-auto  flex flex-col lg:items-center justify-center w-[350px] h-[400px] rounded-lg sm:mb-4 shadow-lg shadow-violet-200'>
