...
function Conocimiento() {
    ...
    return (
        <>
        {/* CARDS MAP */}
        <section name='conocimiento' className='max-w-[1700px] pt-[170px] pb-[170px] px-4 m-auto'>
       ...
       <div className=''>
        ...
        <div className='flex justify-between my-8 mx-4 ease-out p-8 md:flex-row '>
        {data.map((item) => (
            <div className='bg-white p-8 my-0 flex flex-col  w-[350px] h-auto border-[6px] border-slate-100 rounded-lg lg:mr-2'>
